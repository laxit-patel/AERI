...
@section('content')
                        ...
                        <form method="post" action="{{ route('inward.store') }}" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-3 form-group{{ $errors->has('inward_id') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="inward_id" id="input-id" class="form-control form-control-lg font-weight-bold text-white bg-gradient-danger form-control-alternative{{ $errors->has('inward_id') ? ' is-invalid' : '' }}"  value="{{ $key }}" required autofocus disabled>
                            ...
                            <div class=" col-md-6 form-group input-group{{ $errors->has('inward_client') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="inward_client" id="inward_client" class="custom-select custom-select-lg form-control form-control-lg font-weight-bold text-white bg-gradient-danger form-control-alternative{{ $errors->has('inward_client') ? ' is-invalid' : '' }}" required autofocus>
    ...
    <script src="{{ asset('argon') }}/vendor/Chosen/chosen.proto.js"></script>
    <script src="{{ asset('argon') }}/vendor/Chosen/chosen.min.js"></script>
    <script src="{{ asset('argon') }}/vendor/Chosen/chosen.proto.min.js"></script>

    
    <script type="text/javascript">
    console.log('chosen initiated');
    alert("chosen Initiated");
