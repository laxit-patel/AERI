                ...
                <div class="card bg-secondary  shadow-primary">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('inward.store') }}" autocomplete="off">
                            ...
                            <input list="inward_test" name="inward_test" id="input-test" class="form-control form-control-lg font-weight-bold text-white bg-gradient-danger form-control-alternative{{ $errors->has('inward_test') ? ' is-invalid' : '' }}" placeholder="{{ __('Select Test') }}" value="{{ old('inward_test') }}" required autofocus>   
