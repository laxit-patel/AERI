                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('inward.store') }}" autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('client_address') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="client_address" id="input-address" class="form-control form-control-lg font-weight-bold text-white bg-gradient-primary form-control-alternative{{ $errors->has('client_address') ? ' is-invalid' : '' }}" placeholder="Description" value="{{ old('client_address') }}" required >
                                    </textarea>
