            ...
            <div class="col-xl-7 order-xl-1 ">
                <div class="card bg-secondary shadow-primary">
                    <div class="card-header bg-gradient-red border-0">
                        ...
                        <div class="bg-transparent float-right text-white collapsed" type="" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
