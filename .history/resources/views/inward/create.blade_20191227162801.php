                ...
                <div class="card bg-secondary  shadow-primary">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('inward.store') }}" autocomplete="off">
                            ...
                            <div class=" form-group{{ $errors->has('inward_reference') ? ' has-danger' : '' }}">
                                    
                                    <textarea name="inward_description" class="form-control form-control-lg text-white bg-gradient-danger" placeholder="Description" ></textarea>
