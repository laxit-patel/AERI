                        ...
                        <form method="post" action="{{ route('inward.store') }}" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-3 form-group{{ $errors->has('inward_reference') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="inward_reference" id="inward_reference" class="form-control form-control-lg font-weight-bold text-white bg-gradient-danger form-control-alternative{{ $errors->has('inward_reference') ? ' is-invalid' : '' }}" placeholder="{{ $reference }}" value="{{ old('inward_reference') }}" required autofocus>
