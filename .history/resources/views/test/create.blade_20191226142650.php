                        ...
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-2 form-group{{ $errors->has('test_id') ? ' has-danger' : '' }}">
                                ...
                                <div class=" col-md-5 form-group{{ $errors->has('test_iscode') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="test_iscode" id="input-ireference" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_reference') ? ' is-invalid' : '' }}" placeholder="{{ __('IS CODE') }}" value="{{ old('test_iscode') }}" required autofocus>
