                        ...
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('test_duration') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="file" name="test_duration" id="input-material" class="form-control custom-file form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_duration') ? ' is-invalid' : '' }}" placeholder="{{ __('Duration') }}" value="{{ old('test_duration') }}" required >
