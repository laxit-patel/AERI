                        ...
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3 form-group{{ $errors->has('test_rate') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-3 form-group{{ $errors->has('test_rate_cpwd') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-rate">{{ __('Test Rate') }}</label>
                                    <input type="text" name="test_rate_cpwd" id="input-rate" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_rate_cpwd') ? ' is-invalid' : '' }}" placeholder="{{ __('Rates') }}" value="{{ old('test_parameter') }}" required >
                                ...
                                <div class="col-md-3 form-group{{ $errors->has('test_rate_isro') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-rate">{{ __('Test Rate') }}</label>
                                    <input type="text" name="test_rate_isro" id="input-rate" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_rate_isro') ? ' is-invalid' : '' }}" placeholder="{{ __('Rates') }}" value="{{ old('test_parameter') }}" required >
