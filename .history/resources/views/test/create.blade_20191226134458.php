                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-2 form-group{{ $errors->has('test_id') ? ' has-danger' : '' }}">
                                ...
                                <div class=" col-md-5 form-group{{ $errors->has('test_reference') ? ' has-danger' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('test_duration') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-material">{{ __('Test Worksheet Format') }}</label>
                                    <input type="file" name="test_duration" id="input-material" class="form-control custom-file-input form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_duration') ? ' is-invalid' : '' }}" placeholder="{{ __('Duration') }}" value="{{ old('test_duration') }}" required >
                            ...
                            <div class="col-md-3 form-group{{ $errors->has('test_rate') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-3 form-group{{ $errors->has('test_rate_cpwd') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-rate">{{ __('Test Rate C.P.W.D') }}</label>
                                    <input type="text" name="test_rate_cpwd" id="input-rate" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_rate_cpwd') ? ' is-invalid' : '' }}" placeholder="{{ __('Rates') }}" value="{{ old('test_rate_cpwd') }}" required >

                                    @if ($errors->has('test_rate_cpwd'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('test_rate_cpwd') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                <div class="col-md-3 form-group{{ $errors->has('test_rate_isro') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-rate">{{ __('Test Rate I.S.R.O') }}</label>
                                    <input type="text" name="test_rate_isro" id="input-rate" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_rate_isro') ? ' is-invalid' : '' }}" placeholder="{{ __('Rates') }}" value="{{ old('test_rate_cpwd') }}" required >

                                    @if ($errors->has('test_rate_isro'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('test_rate_isro') }}</strong>
                                        </span>
                                    @endif
                                </div>
                             </div>
