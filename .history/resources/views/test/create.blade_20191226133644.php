                        ...
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3 form-group{{ $errors->has('test_rate') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-3 form-group{{ $errors->has('test_rate_mes') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="test_rate" id="input-rate-mes" class="form-control form-control-lg font-weight-bold text-white bg-gradient-info form-control-alternative{{ $errors->has('test_rate') ? ' is-invalid' : '' }}" placeholder="{{ __('Rates') }}" value="{{ old('test_parameter') }}" required >
