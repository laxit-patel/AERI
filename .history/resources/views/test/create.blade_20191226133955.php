                ...
                <div class="card bg-secondary  shadow-primary">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('test.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row">
                            <div class="col-md-4 form-group{{ $errors->has('test_id') ? ' has-danger' : '' }}">
                                ...
                                <div class=" col-md-4 form-group{{ $errors->has('test_reference') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('test_material') ? ' has-danger' : '' }}">
