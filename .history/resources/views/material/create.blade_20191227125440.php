                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('material.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4 form-group{{ $errors->has('material_id') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('material_reference') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('material_name') ? ' has-danger' : '' }}">
                            ...
                            <div class=" form-group{{ $errors->has('material_description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea  name="material_description" id="input-details" class="form-control form-control-lg font-weight-bold text-white bg-gradient-warning form-control-alternative{{ $errors->has('material_description') ? ' is-invalid' : '' }}"  value="{{ old('material_description') }}" required autofocus>
                                    </textarea>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-block btn-lg  btn-success mt-4">{{ __('Add') }}</button>
                                </div>
