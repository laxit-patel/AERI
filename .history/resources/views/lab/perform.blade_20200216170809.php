                                ...
                                <div class="card progress-card bg-gradient-cyan card-stats  mb-lg-0" >
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-auto ">
                                            <button type="button" onclick="progress(this)" class="btn btn-round bg-danger text-white" id="phase_one" data-phase="inward_phase_one" data-status="{{$record->record_phase_one}}"></button>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                ...
                                <div class="card progress-card bg-gradient-cyan card-stats  mb-lg-0" >
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-auto ">
                                            <button type="button" onclick="progress(this)" class="btn btn-round bg-danger text-white" id="phase_two" data-phase="inward_phase_two" data-status="{{$record->record_phase_two}}"></button>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                ...
                                <div class="card progress-card bg-gradient-cyan card-stats  mb-lg-0" >
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-auto ">
                                            <button type="button" onclick="progress(this)" class="btn btn-round bg-danger text-white" id="phase_three" data-phase="inward_phase_three" data-status="{{$record->record_phase_three}}"></button>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                ...
                                <div class="card progress-card bg-gradient-cyan card-stats  mb-lg-0" >
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-auto ">
                                            <button type="button" onclick="progress(this)" class="btn btn-round bg-danger text-white" id="phase_four" data-phase="inward_phase_four" data-status="{{$record->record_phase_four}}"></button>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
