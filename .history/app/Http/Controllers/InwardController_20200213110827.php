...
class InwardController extends Controller
{
    ...
    {
        $inward = DB::select("select inward_id, inward_test, test_id, test_name, inward_client, client_id, client_name, client_gstin, client_address, client_phone from inwards i inner join tests t on i.inward_test = t.test_id inner join clients c on c.client_id = i.inward_client where inward_id = '$inward_id' ");
