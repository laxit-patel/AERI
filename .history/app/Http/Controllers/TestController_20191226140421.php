...
class TestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $test->test_reference = $request->test_reference;
        $test->test_name = $request->test_name;
        $test->test_material = $request->test_material;
        $test->test_duration = $request->test_duration;
        $test->test_worksheet = $test->test_worksheet;
        $test->test_rate = $test->test_rate;
        $test->test_rate_mes = $test->test_rate_mes;
        $test->test_rate_cpwd = $test->test_rate_cpwd;
        $test->test_rate_isro = $test->test_rate_isro;
