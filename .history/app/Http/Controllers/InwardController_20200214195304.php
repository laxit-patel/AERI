...
class InwardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $inward->inward_price = $request->test_price;
        ...
        $records->record_id = $inward_key;
        $records->record_inward = $record_key;
        $record->record_test =  $request->inward_test;
        $record->price = $request->test_price;
        $record->qty = $request->test_qty; 
