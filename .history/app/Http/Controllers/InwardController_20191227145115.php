...
class InwardController extends Controller
{
    ...
    public function create(Inwards $models)
    {
        ...
        $tests = DB::table('tests')->pluck('test_name', 'test_id','test_material');
        $test_name = $tests->test_name;
        $test_id = $tests->test_id;
        $test_material = $test_material;
        return view('inward.create', compact('clients','materials', 'test_name', 'test_id', 'test_material', 'reference','key'));
    }
