...
class TestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $worksheet_extension = $request->file("test_worksheet")->getClientOriginalExtension();

        $worksheet_filename = "worksheet_".$request->test_iscode."_".$material_id.".".$worksheet_extension;

            dd($worksheet_extension);
