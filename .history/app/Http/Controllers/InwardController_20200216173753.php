...
class InwardController extends Controller
{
    ...
    {
        $inward = DB::select("select inward_id, inward_client, inward_report_date,name, id, inward_test, test_id, test_name, test_material, material_id, client_name, material_name from inwards i inner join clients c on i.inward_client = c.client_id inner join tests t on i.inward_test = t.test_id inner join materials m on t.test_material = m.material_id left join users u on u.id = i.inward_assign_to");
