...
class TestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $worksheet_filename = "worksheet_".$key.".".$request->file("test_worksheets")->getClientOriginalExtension();
        ...
        $report_filename = "report_".$key.".".$request->file("test_reports")->getClientOriginalExtension();
        $report_directory = 'test_reports';
        $worksheet_file = $request->file('test_reports')->storeAs($report_directory, $report_filename );
