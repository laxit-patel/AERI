...
class InwardController extends Controller
{
    ...
    public function sendTest(Request $inward_id)
    {
        ...
        $q = "select inward_id, inward_test, test_id, test_name from inwards i inner join tests t on i.inward_test = t.test_id where inward_id = '$inward_id' ";
