...
class InwardController extends Controller
{
    ...
    public function index()
    {
        ...
        $records = DB::table('inwards')->join('tests','record_test','=','tests.test_id')->get();
    ...
    public function edit($inward_id)
    {
        ...
        $clients = Clients::all(['client_id','client_name']);
        $tests = Tests::all(['test_name','test_material','test_id']);
        $records = DB::table('records')->join('tests','record_test','=','tests.test_id')->where('record_inward',$inward_id)->get();
