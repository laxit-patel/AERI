...
class InwardController extends Controller
{
    ...
    {
        $inward = DB::select("select inward_id, inward_status, inward_client, inward_report_date, client_name from inwards i inner join clients c on i.inward_client = c.client_id  ");
